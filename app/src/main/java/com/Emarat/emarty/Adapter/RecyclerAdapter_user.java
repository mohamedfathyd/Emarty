...
public class RecyclerAdapter_user extends RecyclerView.Adapter<RecyclerAdapter_user.MyViewHolder> {
    Typeface myTypeface;
    private Context context;
    List<user_content> contactslist;
     apiinterface_home apiinterface;
    public RecyclerAdapter_user(Context context, List<user_content> contactslist){
