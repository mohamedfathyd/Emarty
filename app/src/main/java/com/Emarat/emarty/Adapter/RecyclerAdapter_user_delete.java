...
import com.Emarat.emarty.Activity.Show_user_details;
...
public class RecyclerAdapter_user_delete extends RecyclerView.Adapter<RecyclerAdapter_user_delete.MyViewHolder> {
    Typeface myTypeface;
    private Context context;
    List<user_content> contactslist;
     apiinterface_home apiinterface;
    public RecyclerAdapter_user_delete(Context context, List<user_content> contactslist){
