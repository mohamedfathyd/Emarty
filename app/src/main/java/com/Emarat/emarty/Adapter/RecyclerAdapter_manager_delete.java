...
public class RecyclerAdapter_manager_delete extends RecyclerView.Adapter<RecyclerAdapter_manager_delete.MyViewHolder> {
    Typeface myTypeface;
    private Context context;
    List<user_content> contactslist;
     apiinterface_home apiinterface;
    public RecyclerAdapter_manager_delete(Context context, List<user_content> contactslist){
...
public static class MyViewHolder extends RecyclerView.ViewHolder {
    ...
    public void fetchInfo(int id) {
        ...
        call=apiinterface.delete_manager(id);
