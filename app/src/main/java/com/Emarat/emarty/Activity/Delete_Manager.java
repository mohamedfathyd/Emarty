...
public class Delete_Manager extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_delete__manager);
    ...
    public void fetchInfo() {
        ...
        Call<List<user_content>> call = apiinterface.getcontacts_manger();
        call.enqueue(new Callback<List<user_content>>() {
            ...
            public void onResponse(Call<List<user_content>> call, Response<List<user_content>> response) {
                ...
                recyclerAdapter_secondry = new RecyclerAdapter_manager_delete(Delete_Manager.this, contactList);
