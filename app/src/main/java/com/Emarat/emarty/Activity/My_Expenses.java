...
public class My_Expenses extends AppCompatActivity {

    Toolbar toolbar;
    ProgressBar progressBar;
    private RecyclerView recyclerView;
    private RecyclerView.LayoutManager layoutManager;
    private RecyclerAdapter_exp recyclerAdapter_secondry;
    private List<Exp_content> contactList;
...
ImageView aa;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my__expenses);
    ...
    public void fetchInfo() {
        ...
        call.enqueue(new Callback<List<Exp_content>>() {
            ...
            public void onResponse(Call<List<Exp_content>> call, Response<List<Exp_content>> response) {
                ...
                recyclerAdapter_secondry = new RecyclerAdapter_exp(My_Expenses.this, contactList);
