...
public class MyRecervation_month extends AppCompatActivity {
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_recervation_month);
    ...
    public void fetchInfo() {
        ...
        call.enqueue(new Callback<List<Reservation_content>>() {
            ...
            public void onResponse(Call<List<Reservation_content>> call, Response<List<Reservation_content>> response) {
                ...
                progressBar.setVisibility(View.GONE);
                recyclerAdapter_secondry = new RecyclerAdapter_recervations (MyRecervation_month.this, contactList);
